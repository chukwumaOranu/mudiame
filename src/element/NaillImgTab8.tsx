...
const nailLarge = [IMAGE.nailLargePic8, IMAGE.nailLargePic8, IMAGE.nailLargePic8, IMAGE.nailLargePic8, IMAGE.nailLargePic8,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                <h6 className="title">Gems Art   <span className="text-primary">₹ 199</span></h6>
                                <img ref={imgRef} src={IMAGE.nailLargePic8} alt="" />
                            </div>
                        </div>
                    </div>
