...
const nailLarge = [IMAGE.nailLargePic6, IMAGE.nailLargePic6, IMAGE.nailLargePic6, IMAGE.nailLargePic6, IMAGE.nailLargePic6,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                ...
                                <img ref={imgRef} src={IMAGE.nailLargePic6} alt="" />
                            </div>
                        </div>
                    </div>
