...
const nailLarge = [IMAGE.nailLargePic9, IMAGE.nailLargePic9, IMAGE.nailLargePic9, IMAGE.nailLargePic9, IMAGE.nailLargePic9,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                <h6 className="title">Plain Mix   <span className="text-primary">₹ 199</span></h6>
                                <img ref={imgRef} src={IMAGE.nailLargePic9} alt="" />
                            </div>
                        </div>
                    </div>
