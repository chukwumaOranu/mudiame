...
const nailLarge = [IMAGE.nailLargePic7, IMAGE.nailLargePic7, IMAGE.nailLargePic7, IMAGE.nailLargePic7, IMAGE.nailLargePic7,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                <h6 className="title">'Deco Glitter   <span className="text-primary">₹ 199</span></h6>
                                <img ref={imgRef} src={IMAGE.nailLargePic7} alt="" />
                            </div>
                        </div>
                    </div>
