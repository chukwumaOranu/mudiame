...
const nailSmall = [
    { img: IMAGE.nailSmallPic1 },
    { img: IMAGE.nailSmallPic2 },
    { img: IMAGE.nailSmallPic3 },
    { img: IMAGE.nailSmallPic4 },
    { img: IMAGE.nailSmallPic5 },
];
const nailLarge = [IMAGE.nailLargePic1, IMAGE.nailLargePic1, IMAGE.nailLargePic1, IMAGE.nailLargePic1, IMAGE.nailLargePic1,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                <h6 className="title">Decals<span className="text-primary">₹ 199</span></h6>
                                <img ref={imgRef} src={IMAGE.nailLargePic1} alt="" />
                            </div>
                        </div>
                    </div>
