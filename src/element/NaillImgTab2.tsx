...
const nailLarge = [IMAGE.nailPic2, IMAGE.nailPic2, IMAGE.nailPic2, IMAGE.nailPic2, IMAGE.nailPic2,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                <h6 className="title">Gems Glitter   <span className="text-primary">₹ 199</span></h6>
                                <img ref={imgRef} src={IMAGE.nailLargePic2} alt="" />
                            </div>
                        </div>
                    </div>
