...
const nailLarge = [IMAGE.nailLargePic4, IMAGE.nailLargePic4, IMAGE.nailLargePic4, IMAGE.nailLargePic4, IMAGE.nailLargePic4,]
                    ...
                    <div className="tab-content" id="myTabContentInnerNails1">
                        <div className="tab-pane fade show active" id="nailTabInner1">
                            <div className="nail-info">
                                <h6 className="title">Text Color   <span className="text-primary">₹ 199</span></h6>
                                <img ref={imgRef} src={IMAGE.nailPic4} alt="" />
                            </div>
                        </div>
                    </div>
